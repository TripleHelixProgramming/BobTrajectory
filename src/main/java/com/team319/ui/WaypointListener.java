...
public class WaypointListener {
    ...
    private class WaypointCreator extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            DraggableWaypoint newWaypoint = new DraggableWaypoint(panel.convertXFromPixel(e.getX()), panel.convertYFromPixel(e.getY()), heading, 0, RobotConfig.maxVelocity, panel);
